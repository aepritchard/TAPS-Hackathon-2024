...
initial = initial[,c("Team", "Date", "Depth", "Inital_Moisture", "Initial_Soil_Temp", "Sensor")]
...
all_sensor_weather_irrigation_data = merge3[,c("Team", "Depth", "Sensor", 
                                               ...
                                               "TEMP2MAVG","TEMP2MMIN", "TEMP2MMAX", "Amount", "Inital_Moisture", "Initial_Soil_Temp")]
colnames(all_sensor_weather_irrigation_data) = c("Team", "Depth", "Sensor", 
                                               "Timestamp", "Summarization_level", "Moisture", "Soil_Temp", "PRECIP",
                                               "TEMP2MAVG","TEMP2MMIN", "TEMP2MMAX", "Irrigation_Amount", "Inital_Moisture", "Initial_Soil_Temp")
