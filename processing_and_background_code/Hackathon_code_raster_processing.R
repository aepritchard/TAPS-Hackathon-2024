...
all_imaging_combined = st_drop_geometry(rbind(combined, combined_drones)[,c("Plot_ID", "raster_value", "date", "image_type")])
write.csv(all_imaging_combined, "all_imaging_combined.csv")
